...
export function Topbar({ onMenuToggle }: TopbarProps) {
  const { student, connectWalletAction } = useAuth();
    ...
    <header className="h-14 flex items-center justify-between px-4 md:px-6 border-b border-[rgba(255,255,255,0.06)] bg-[#0f1117] flex-shrink-0 z-30">
      ...
      <div className="flex items-center gap-2.5">
        ...
        {student?.walletAddress ? (
          ...
          <button
            className="hidden sm:block text-[11.5px] font-mono text-[#f5a623] bg-[rgba(245,166,35,0.10)] border border-[rgba(245,166,35,0.2)] rounded-full px-3 py-1.5 hover:bg-[rgba(245,166,35,0.16)] transition-colors"
        ...
        <div
          className="w-8 h-8 rounded-full flex items-center justify-center text-[12px] font-bold text-[#050708] flex-shrink-0"
