...
import { Mail, Lock, User, Hash, BookOpen, GraduationCap, Eye, EyeOff } from "lucide-react";
...
const PROGRAMMES = [
  ...
  "Information Technology", "Electrical Engineering", "Civil Engineering",
      ...
      <Card>
        <CardBody className="p-6">
          <div className="mb-6">
            ...
            <p className="text-[13px] text-[#8b8fa8] mt-1">Register with your university details</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-[11.5px] font-mono uppercase tracking-wide text-[#8b8fa8]">Programme</label>
              <div className="relative">
                ...
                >
                  <option value="" disabled className="bg-[#0f1420]">Select programme</option>
                  {PROGRAMMES.map(p => <option key={p} value={p} className="bg-[#0f1420]">{p}</option>)}
                </select>
              </div>
            </div>
            ...
            {/* Level */}
            <div className="flex flex-col gap-1.5">
              <label className="text-[11.5px] font-mono uppercase tracking-wide text-[#8b8fa8]">Year of Study</label>
          ...
          <p className="text-[12.5px] text-[#8b8fa8] text-center mt-5">
            Already registered?{" "}
            <Link to="/login" className="text-[#00e5a0] hover:underline">Sign in</Link>
          </p>
        </CardBody>
      </Card>
    </div>
