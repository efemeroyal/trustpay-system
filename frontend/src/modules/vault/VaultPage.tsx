      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-3 justify-between">
        <div>
          ...
          <p className="text-sm text-[#8b8fa8] mt-0.5">
            {receipts.length} Soulbound Token{receipts.length !== 1 ? "s" : ""}{" "}
      ...
      <div className="grid grid-cols-3 gap-3">
        {[
          ...
          >
            ...
            <p className="font-semibold text-[15px]" style={{ color: s.color }}>
              {s.value}
            </p>
          </div>
        ))}
...
function ReceiptCard({ receipt }: { receipt: SBTReceipt }) {
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(145deg, #0d1a14 0%, #0a1220 50%, #120e1a 100%)",
      }}
    >
      {/* Grid pattern */}
      ...
      <div className="relative z-10 p-5">
        ...
        <div className="grid grid-cols-2 gap-3 mb-4">
          <div>
            <p className="text-[9.5px] font-mono uppercase tracking-wide text-[#8b8fa8] mb-0.5">
              Student ID
            </p>
            <p className="text-[12.5px] font-mono font-medium">
              {receipt.studentId}
            </p>
          </div>
          <div>
            ...
            <p className="text-[12.5px] font-mono font-bold text-[#00e5a0]">
