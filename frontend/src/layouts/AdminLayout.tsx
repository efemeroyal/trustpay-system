...
const NAV = [
  { to: "/admin/verify", icon: ScanLine, label: "Verify Receipt" },
  { to: "/admin/receipts", icon: Receipt, label: "All Receipts" },
    ...
    <div className="min-h-screen bg-[#070a0f] flex">
      ...
      >
        ...
        <div className="flex items-center gap-3 px-5 py-5 border-b border-[rgba(255,255,255,0.06)]">
          <div className="w-8 h-8 rounded-lg bg-[#4f9cf9] flex items-center justify-center flex-shrink-0">
        ...
        {/* Admin info */}
        <div className="px-4 py-3 mx-3 mt-3 rounded-xl bg-[rgba(79,156,249,0.04)] border border-[rgba(79,156,249,0.1)]">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-full bg-[#4f9cf9] flex items-center justify-center flex-shrink-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[10px] font-mono text-[#4f9cf9]">
                Bursary Staff
              </p>
            </div>
          </div>
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                cn(
                  ...
                  isActive
                    ? "bg-[rgba(79,156,249,0.1)] text-[#4f9cf9]"
        ...
        <div className="px-3 pb-5 border-t border-[rgba(255,255,255,0.06)] pt-3">
          <button
            ...
            className="w-full flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-[13px] font-medium text-[#8b8fa8] hover:text-[#ff5757] hover:bg-[rgba(255,87,87,0.06)] transition-all"
          >
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="sticky top-0 z-30 flex items-center justify-between px-4 sm:px-6 py-3.5 glass border-b border-[rgba(255,255,255,0.06)]">
          ...
          <div className="hidden lg:flex items-center gap-2">
            <span className="w-1.5 h-1.5 rounded-full bg-[#4f9cf9] pulse-dot" />
          ...
          <div className="flex items-center gap-2 ml-auto">
            <button className="relative p-2 rounded-lg text-[#8b8fa8] hover:text-[#e8eaf0] hover:bg-[rgba(255,255,255,0.04)] transition-colors">
              ...
              {unreadCount > 0 && (
                <span className="absolute top-1.5 right-1.5 w-1.5 h-1.5 rounded-full bg-[#4f9cf9]" />
              )}
            </button>
          </div>
        </header>
